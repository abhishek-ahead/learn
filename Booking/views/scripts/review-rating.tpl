...
<div class="form-wrapper booking_form_rating_star">
  <div class="form-label"><label class="required"><?php echo $this->translate("Overall Rating"); ?></label></div>
  <div id="sesevent_review_rating" class="sesbasic_rating_star seseventreview_rating_star_element" onmouseout="rating_out();">
    <span id="rate_1" class="rating_star_big_generic rating_star_big_disabled" onclick="rate(1);" onmouseover="rating_over(1);"></span>
    <span id="rate_2" class="rating_star_big_generic rating_star_big_disabled" onclick="rate(2);" onmouseover="rating_over(2);"></span>
    <span id="rate_3" class="rating_star_big_generic rating_star_big_disabled" onclick="rate(3);" onmouseover="rating_over(3);"></span>
    <span id="rate_4" class="rating_star_big_generic rating_star_big_disabled" onclick="rate(4);" onmouseover="rating_over(4);"></span>
    <span id="rate_5" class="rating_star_big_generic rating_star_big_disabled" onclick="rate(5);" onmouseover="rating_over(5);"></span>
