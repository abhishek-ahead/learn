...
<div class='sesbasic-form sesbasic-categories-form'>
  <div>
    ...
    <?php endif; ?>
    <h3><?php echo $this->translate("Payments Made to Professionals") ?></h3>
    <p><?php echo $this->translate('This page lists all of the payments made to the professionals owners on your website. You can use this page to monitor these payments made. Entering criteria into the filter fields will help you find specific payment detail. Leaving the filter fields blank will show all the payments made to professionals owners on your social network.'); ?></p>
    <br />
