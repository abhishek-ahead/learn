          ...
          try {
            ...
            if ($photo) {
              ...
              <div class="comment_image comment_media_thumb clearfix" data-fileid="<?php echo $fileid->file_id; ?>"
                ...
                <a <?php if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('ealbum')) { ?> class="core-image-viewer"
                    onclick="getRequestedAlbumPhotoForImageViewer('<?php echo $photo->getPhotoUrl(); ?>','<?php echo Engine_Api::_()->ealbum()->getImageViewerHref($photo) ?>')"
          ...
          try {
            ...
            if ($video) {
              ...
              <div class="comment_image comment_media_thumb clearfix" data-fileid="<?php echo $fileid->file_id; ?>"
                data-type="<?php echo $fileid->type; ?>">
                <img src="<?php echo $path; ?>" style="display:none;">
                <a class="evideo_thumb_img" href="<?php echo $video->getHref() ?>"><span
