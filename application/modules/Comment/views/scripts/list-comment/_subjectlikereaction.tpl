    ...
    <?php if ($commentCount > 0) { ?>
      <a class=" comment_btn_open select_action_<?php echo $subject->getIdentity(); ?>" data-subjectid="<?php echo $subject->getIdentity(); ?>" data-subjecttype="<?php echo $subject->getType(); ?>" href="javascript:void(0);">
        ...
        <div class="comment_pulldown_wrapper  dropdown" data-actionid="<?php echo $subject->getIdentity(); ?>">
          <a href="javascript:void(0);" class="search_advcomment_txt dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"><span><?php echo $this->translate('Oldest'); ?></span></a>
          <ul class="dropdown-menu search_adv_comment dropdown-menu-end">
            <li><a href="javascript:;" data-subjectype="<?php echo $subject->getType(); ?>" data-type="newest" class="dropdown-item subject search_adv_comment_a"><?php echo $this->translate("Newest"); ?></a>
            </li>
            <li><a href="javascript:;" data-subjectype="<?php echo $subject->getType(); ?>" data-type="oldest" class="dropdown-item subject search_adv_comment_a active"><?php echo $this->translate("Oldest"); ?></a>
            </li>
          </ul>
