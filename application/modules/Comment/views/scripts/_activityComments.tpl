      ...
      <div class='feed_item_date feed_item_icon <?php // echo $icon_type ?>'>
        ...
        <?php } ?>  
          ...
          <?php endif; ?>
            ...
            <?php if($action->type != "friends" && strlen(preg_replace("/(\\\u[0-9a-f]{4})+?|\s+/","",strip_tags($content))) && Engine_Api::_()->getApi('settings', 'core')->getSetting('activity.translate', 0)){
             ...
             ?>
              <!-- <li class="feed_item_option_translate">
                <a href="javascript:void(0);"
                      onClick="socialSharingPopUp('https://translate.google.com/#auto/<?php //echo $languageTranslate; ?>/<?php //echo urlencode(strip_tags($action->body)); ?>','Google');return false;">
