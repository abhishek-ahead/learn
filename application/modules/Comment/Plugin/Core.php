...
class Comment_Plugin_Core {
  ...
  public function onRenderLayoutDefault($event, $mode = null) {
    ...
    if($viewer->getIdentity()) {
      ...
      $album = $video = 0;
      if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('album') || Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('ealbum')){
        $album = 1; 
      }
      ...
      if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('video')) {
        $video = 1; 
        $videoType = 'video'; 
      } else if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('evideo')){
        $video = 1; 
        $videoType = 'evideo'; 
      }
