...
class Harmony_Form_Admin_Settings_Fonts extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Text', 'harmony_body_fontsize', array(
      ...
      'allowEmpty' => false,
      'required' => true,
      'value' => $settings->getSetting('elpis.body.fontsize', '.9em'),
    ));
    ...
    $this->addElement('Text', 'harmony_googlebody_fontsize', array(
      ...
      'allowEmpty' => false,
      'required' => true,
      'value' => $settings->getSetting('harmony_googlebody_fontsize','.9em'),
    ));
    ...
    $this->addElement('Text', 'harmony_heading_fontsize', array(
      ...
      'allowEmpty' => false,
      'required' => true,
      'value' => $settings->getSetting('harmony_heading_fontsize', '1.1em'),
    ));
    ...
    $this->addElement('Text', 'harmony_googleheading_fontsize', array(
      ...
      'allowEmpty' => false,
      'required' => true,
      'value' => $settings->getSetting('harmony_googleheading_fontsize', '1.1em'),
    ));
    ...
    $this->addElement('Text', 'harmony_mainmenu_fontsize', array(
      ...
      'allowEmpty' => false,
      'required' => true,
      'value' => $settings->getSetting('harmony_mainmenu_fontsize', '.9em'),
    ));
    ...
    $this->addElement('Text', 'harmony_googlemainmenu_fontsize', array(
      ...
      'allowEmpty' => false,
      'required' => true,
      'value' => $settings->getSetting('harmony_googlemainmenu_fontsize', '.9em'),
    ));
