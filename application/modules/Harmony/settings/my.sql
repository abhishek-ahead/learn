...
UPDATE `engine4_core_menuitems` SET `params` = '{"icon":"fi fi-rs-home"}' WHERE `engine4_core_menuitems`.`name` = "core_main_home";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"user_general","action":"browse","icon":"fi fi-rs-users"}' WHERE `engine4_core_menuitems`.`name` = "core_main_user";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"default","module":"invite","icon":"fa fa-envelope"}' WHERE `engine4_core_menuitems`.`name` = "core_main_invite";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"bizlist_general","icon":"fi fi-rr-business-time"}' WHERE `engine4_core_menuitems`.`name` = "core_main_bizlist";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"poll_general","action":"browse","icon":"fi fi-rr-square-poll-vertical"}' WHERE `engine4_core_menuitems`.`name` = "core_main_poll";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"blog_general","icon":"fi fi-rr-blog-pencil"}' WHERE `engine4_core_menuitems`.`name` = "core_main_blog";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"travel_general","icon":"fi fi-rr-suitcase-alt"}' WHERE `engine4_core_menuitems`.`name` = "core_main_travel";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"album_general","action":"browse","icon":"fi fi-rr-picture"}' WHERE `engine4_core_menuitems`.`name` = "core_main_album";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"video_general","icon":"fi fi-rr-play-alt"}' WHERE `engine4_core_menuitems`.`name` = "core_main_video";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"event_general","icon":"fi fi-rr-calendar-star"}' WHERE `engine4_core_menuitems`.`name` = "core_main_event";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"employment_general","icon":"fi fi-rr-briefcase"}' WHERE `engine4_core_menuitems`.`name` = "core_main_employment";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"classified_general","icon":"fi fi-rr-document"}' WHERE `engine4_core_menuitems`.`name` = "core_main_classified";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"default","module":"chat","icon":"fi fi-rs-comment"}' WHERE `engine4_core_menuitems`.`name` = "core_main_chat";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"forum_general","icon":"fi fi-rr-form"}' WHERE `engine4_core_menuitems`.`name` = "core_main_forum";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"music_general","action":"browse","icon":"fi fi-rr-music-alt"}' WHERE `engine4_core_menuitems`.`name` = "core_main_music";
UPDATE `engine4_core_menuitems` SET `params` = '{"route":"group_general","icon":"fi fi-rr-users-alt"}' WHERE `engine4_core_menuitems`.`name` = "core_main_group";
...
('harmony.body.fontsize', '0.875rem'),
...
('harmony.googlebody.fontsize', '0.875rem'),
('harmony.googlefonts', '0'),
('harmony.googleheading.fontfamily', '\"ABeeZee\"'),
('harmony.googleheading.fontsize', '0.9375rem'),
('harmony.googlemainmenu.fontfamily', '\"ABeeZee\"'),
('harmony.googlemainmenu.fontsize', '0.75rem'),
...
('harmony.heading.fontsize', '0.9375rem'),
('harmony.helpenable', '1'),
('harmony.mainmenu.fontfamily', 'Default Font'),
('harmony.mainmenu.fontsize', '0.75rem'),
