...
<div class="elpis_styling_buttons">
  ...
  <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="<?php echo $this->translate('You can not delete this theme, until its deactivated.'); ?>" class="elpis_button fa fa-close disabled" id="deletedisabled_custom_themes" style="display: none;"><?php echo $this->translate("Delete Custom Theme"); ?></a>
</div>
