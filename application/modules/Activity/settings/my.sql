...
ALTER TABLE `engine4_activity_actions` ADD INDEX `action_id` (`action_id`, `approved`, `is_community_ad`);


ALTER TABLE `engine4_activity_likes` ADD COLUMN IF NOT EXISTS  `type` TINYINT(1) NOT NULL DEFAULT 1;
ALTER TABLE `engine4_activity_likes` ADD INDEX(`type`);
...
ALTER TABLE `engine4_core_likes` ADD INDEX(`type`);
