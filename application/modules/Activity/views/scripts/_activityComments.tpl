            ...
            <?php else: ?>
              <?php foreach( $action->getAttachments() as $attachment ): ?>
                ...
                <?php elseif( $attachment->meta->mode == 3 ): // Description only type actions ?>
                  <?php echo $this->viewMore($attachment->item->getDescription(), 255, 50000, 511, true); ?>
                ...
                <li id="comment-<?php echo $comment->comment_id ?>">
                  ...
                  <div class="comments_info">
                   ...
                   <span class="comments_body">
                    <?php echo $this->viewMore(Engine_Text_Emoji::decode($comment->body), 255, 50000, 511, true) ?>
                   </span>
