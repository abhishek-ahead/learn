 ...
 * @version    $Id: _socialShare.tpl 10194 2014-05-01 17:41:40Z mfeineman $
 * @author     Jung
 */
?>
<?php 
...
<div class="invite_invite_friend">
  <div class="invite_referral_field">
    ...
    <a href="javascript:void(0)" class="copy_itemurl" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?php echo $this->translate("Copy");?>">
  ...
  <?php if($settings->getSetting('core.socialshare.enable', 1)) { ?>
    ...
    <div class="social_share_icons">
       ...
       <?php if(engine_in_array('twitter', $socialshare_allow)) { ?>
         <div class="social_share_icon">
           <a class="twitter" target="_blank" href="<?php echo 'https://twitter.com/intent/tweet?url=' . $URL . '&text=%0a'; ?>">
       ...
       <?php if(engine_in_array('pinterest', $socialshare_allow)) { ?>
        ...
        <?php if(engine_in_array('linkedin', $socialshare_allow)) { ?>
          <div class="social_share_icon">
            <a  class="linkedin" target="_blank" href="<?php echo 'https://www.linkedin.com/shareArticle?mini=true&url='.$URL; ?>">
        ...
        <?php if(engine_in_array('flipboard', $socialshare_allow)) { ?>
          <div class="social_share_icon"> 
            <a class="flipboard" target="_blank" href="<?php echo 'https://share.flipboard.com/bookmarklet/popout?v=2&url='.$URL ?>">
            <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M0 32v448h448V32H0zm358.4 179.2h-89.6v89.6h-89.6v89.6H89.6V121.6h268.8v89.6z"/></svg></i>
            </a>
          </div>  
        <?php } ?>
...
<script type="text/javascript">
  scriptJquery(document).on('click','.copy_itemurl',function (e){
