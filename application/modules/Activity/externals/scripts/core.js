...
//   var container = scriptJquery(".activity_pulldown_wrapper");
//   if (!container.is(e.target) // if the target of the click isn't the container...
//     && container.has(e.target).length === 0) // ... nor a descendant of the container
//   {
//     container.removeClass('activity_pulldown_active');
//     //container.hide();
//   } else if(scriptJquery(e.target).hasClass('activity_pulldown_wrapper') || scriptJquery(e.target).closest('.activity_pulldown_wrapper').length){
//     if(scriptJquery(e.target).hasClass('activity_pulldown_wrapper')){
//       if( scriptJquery(e.target).hasClass('activity_pulldown_active'))
//         scriptJquery(e.target).removeClass('activity_pulldown_active');
//       else {
//         container.removeClass('activity_pulldown_active');
//         scriptJquery(e.target).addClass('activity_pulldown_active');
//       }
//     } else {
//       if( scriptJquery(e.target).closest('.activity_pulldown_wrapper').hasClass('activity_pulldown_active'))
//         scriptJquery(e.target).closest('.activity_pulldown_wrapper').removeClass('activity_pulldown_active');
//       else {
//         container.removeClass('activity_pulldown_active');
//         scriptJquery(e.target).closest('.activity_pulldown_wrapper').addClass('activity_pulldown_active');
//       }
//     }
//   }
// });
...
// AttachEventListerSE('click','.activity_chooser_btn',function(){
//   if(scriptJquery(this).hasClass('active')) {
//     scriptJquery(this).removeClass('active');
//     scriptJquery('.activity_content_pulldown').hide();
//   }else{
//     scriptJquery('.activity_content_pulldown').show();
