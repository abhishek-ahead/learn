...
class Fields_Form_Standard extends Engine_Form
{
  ...
  public function generate()
  {
    ...
    // if($this->getItem() && $this->getItem()->getType() == 'user') {
    //   $settings = Engine_Api::_()->getApi('settings', 'core');
      
    //   $this->addElement('Dummy', 'personalheading', array(
    //     'content' => '<div class="form-wrapper-heading"><span show="1" class="field_container">Personal Information</span></div>',
    //     'order' => $orderIndex++,
    //   ));

    //   // Element: first name
    //   $this->addElement('Text', 'firstname', array(
    //     'label' => '<i class="fa fa-user"></i>' . Zend_Registry::get('Zend_Translate')->_('First Name'),
    //     'required' => true,
    //     'allowEmpty' => false,
    //     'autofocus' => 'autofocus',
    //     'validators' => array(
    ...
    //     'order' => $orderIndex++,
    //   ));
    //   $this->getElement('firstname')->getDecorator('label')->setOption('escape', false);
    //   $this->firstname->getValidator('NotEmpty')->setMessage('Please enter a valid profile address.', 'isEmpty');
      
    //   // Element: last name
    //   $this->addElement('Text', 'lastname', array(
    //     'label' => '<i class="fa fa-user"></i>' . Zend_Registry::get('Zend_Translate')->_('Last Name'),
    //     'required' => true,
    //     'allowEmpty' => false,
    //     'validators' => array(
    //       array('NotEmpty', true),
    ...
    //     'order' => $orderIndex++,
    //   ));
    //   $this->getElement('lastname')->getDecorator('label')->setOption('escape', false);
    //   $this->lastname->getValidator('NotEmpty')->setMessage('Please enter a valid profile address.', 'isEmpty');
      
    //   if( $settings->getSetting('user.signup.dob', 1) > 0 ) {
    //     // Element: Date of birth
    //     $dob = new Engine_Form_Element_Birthdate('dob');
    //     $dob->setLabel('<i class="fa fa-calendar-alt"></i>' . Zend_Registry::get('Zend_Translate')->_('Birthday'));
    //     //$dob->setAllowEmpty(false);
    //     //$dob->setRequired(true);
    //     $dob->setOrder($orderIndex++);
    //     $this->addElement($dob);
    //     $this->getElement('dob')->getDecorator('label')->setOption('escape', false);
    //   }
      
    //   if( $settings->getSetting('user.signup.gender', 1) > 0 ) {
    //     // Element: Gender
    //     $this->addElement('Select', 'gender', array(
    //       'label' => '<i class="fa fa-venus-mars"></i>' . Zend_Registry::get('Zend_Translate')->_('Gender'),
    //       'multiOptions' => array(
    //         '' => '',
    //         'male' => 'Male',
    //         'female' => 'Female',
    ...
    //       'order' => $orderIndex++,
    //     ));
    //     $this->getElement('gender')->getDecorator('label')->setOption('escape', false);
    //   }
    // }
