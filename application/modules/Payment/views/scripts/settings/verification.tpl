                    ...
                    <div class="form-elements">
                      ...
                      <?php if(Engine_Api::_()->getApi('settings', 'core')->getSetting("payment.enablewallet",1)) { ?>
                        <?php if($this->price_verified > $this->user->wallet_amount) { ?>
                          <div class="tip">
                            <span><?php echo $this->translate("You don't have enough balance for verification subscription, please first recharge your "); ?><a href="<?php echo $this->url(array("module" => 'payment', 'controller' => 'settings', 'action' => 'wallet'), 'default', true); ?>" target="_blank"><?php echo $this->translate(" wallet"); ?>.</a></span>
                          </div>
