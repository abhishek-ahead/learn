...
ALTER TABLE `engine4_users` ADD COLUMN IF NOT EXISTS `follow_verification` TINYINT(1) NOT NULL DEFAULT '0';
ALTER TABLE `engine4_users` ADD COLUMN IF NOT EXISTS `follow_count` INT(11) NOT NULL DEFAULT "0";
...
ALTER TABLE `engine4_users` ADD COLUMN IF NOT EXISTS `profile_type` INT(11) NOT NULL DEFAULT '1';
...
ALTER TABLE `engine4_users` ADD COLUMN IF NOT EXISTS `avatar_id` INT(11) NOT NULL DEFAULT '0';
...
ALTER TABLE `engine4_users` ADD COLUMN IF NOT EXISTS `phone_number` VARCHAR(45) NULL;
ALTER TABLE `engine4_users` ADD COLUMN IF NOT EXISTS `country_code` VARCHAR(16) NULL;
ALTER TABLE `engine4_users` ADD COLUMN IF NOT EXISTS `enable_verification` tinyint(1) NOT NULL DEFAULT "0";
