...
ALTER TABLE `engine4_user_fields_search` ADD `first_name` VARCHAR(255) NULL, ADD `last_name` VARCHAR(255) NULL, ADD `gender` smallint(6) unsigned NULL, ADD `birthdate` DATE NULL;

ALTER TABLE `engine4_user_fields_search` ADD INDEX(`first_name`);
ALTER TABLE `engine4_user_fields_search` ADD INDEX(`last_name`);
ALTER TABLE `engine4_user_fields_search` ADD INDEX(`gender`);
ALTER TABLE `engine4_user_fields_search` ADD INDEX(`birthdate`);
