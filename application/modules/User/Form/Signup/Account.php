...
class User_Form_Signup_Account extends Engine_Form_Email
{
  public function init()
  {
    ...
    // $this->addDisplayGroup(array('firstname', 'lastname'), 'fullname');
    ...
    if((empty($_SESSION['twitter_signup']) || empty($_SESSION['google_signup']) || empty($_SESSION['telegram_signup']) || empty($_SESSION['linkedin_signup']))) {
      ...
      $this->addElement('Password', 'password', array(
        'label' => 'Password',
        'description' => !empty($_GET['restApi']) ? 'Write your password...' : '',
        'required' => true,
        'allowEmpty' => false,
        'id' => 'signup_password',
        'validators' => array(
    ...
    // if(isset($enablesigupfields) && engine_in_array('dob', $enablesigupfields)) {
    //   // Element: Date of birth
    //   $dob = new Engine_Form_Element_Birthdate('dob');
    //   $dob->setLabel("Birthday");
    //   //$dob->setAllowEmpty(false);
    //   //$dob->setRequired(true);
    //   $this->addElement($dob);
    // }
    
    // if(isset($enablesigupfields) && engine_in_array('gender', $enablesigupfields)) {
    //   // Element: Gender
