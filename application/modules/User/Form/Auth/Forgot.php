...
class User_Form_Auth_Forgot extends Engine_Form
{
  public function init()
  {
    ...
    if(!empty($otpsms_signup_phonenumber)) {
      ...
      $description = 'If you cannot login because you have forgotten your password, please enter your email address or phone number in the field below to reset the password.';
      $NotEmpty = "Please enter a valid phone number or email address.";
    } else {
      $label = 'Email Address';
      $description = 'If you cannot login because you have forgotten your password, please enter your email address in the field below to reset the password.';
