      ...
      scriptJquery(document).ready(function() {
        ...
        scriptJquery('#country_code').selectize({
          onInitialize: function(){
            ...
            if(typeof selectize.options[selectize.items[0]] != 'undefined') {
              ...
              if(typeof image != 'undefined') {
                scriptJquery(selectize.$control[0]).prepend(`<div class="item" data-value="${selectize.options[selectize.items[0]].value}"><img src="${image}" height="20" width="20"> +${selectize.options[selectize.items[0]].value}</div>`);
              } else {
          ...
          onDropdownClose: function(dropdown) {
            ...
            if(typeof image != 'undefined') {
              that.html(`<img src="${image}" height="20" width="20"> +${that.data('value')}`);
            } else {
              if(typeof that.find('img') != 'undefined' && that.find('img').length) {
                that.html(`<img src="${that.find('img').attr('src')}" height="20" width="20"> +${that.data('value')}`);
              } else {
