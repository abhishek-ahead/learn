...
//       ]);
  ...
  public function getOtpExpire() {
    ...
    return '<div id="timer">'.$this->_translate->translate('Expire in ') . "<span class='otpsms_timer_class' data-time='".$expiretime."' data-endtime='".$endtime."' data-created=''>".$endtimeMin."</span></div>";
  }
}
